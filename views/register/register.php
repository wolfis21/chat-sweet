            ...
            <div class="form-value">
                <form action="?c=Users&a=save" method="POST">
                    ...
                    <div class="input-box">                       
                        ...
                        <input type="text" autocomplete="off" required name="user">
                    ...
                    <div class="input-box">
                        <i class="fa-solid fa-lock"></i>
                        <input type="password" autocomplete="off" required name="verificar_password">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" autocomplete="off" required name="last_name">
